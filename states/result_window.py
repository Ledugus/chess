...
class ResultWindow(State):
    def __init__(self, game, winner):
        ...
        self.pos = ((self.game.SCREEN_WIDTH-self.window_width)/2, (self.game.SCREEN_HEIGHT-self.window_height)/2)

        self.window = p.surface.Surface((self.window_width, self.window_height))
        self.window_rect = self.window.get_rect()
        self.new_game_button = Button(image=p.image.load("images/play_image.png"), pos=(self.pos[0]+self.window_width/2, self.pos[1]+150),
                                  text_input="New Game", font=get_font(30), height=50)
        self.menu_button = Button(image=p.image.load("images/play_image.png"), pos=(self.pos[0]+self.window_width/2, self.pos[1]+250),
                                  text_input="Menu", font=get_font(30), height=50)
        self.close_button = Button(image=p.image.load("images/close_button.png"), pos=(self.pos[0]+self.window_width-30, self.pos[1]+30),
                                   text_input="", font=get_font(20), height=20)
        self.window = p.surface.Surface((self.window_width, self.window_height))
    ...
    def render(self, screen):
        ...
        self.game.draw_text(self.window, self.winner_text(), get_font(50), p.Color("black"), self.window_width/2, 50)
